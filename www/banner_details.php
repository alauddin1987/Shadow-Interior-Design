  ...
  <tr>
    ...
    <td valign="top" border="0" width="1025px"><table width="100%" border="0" cellpadding="3" cellspacing="5">
      <tr>
        ...
        <?php include_once(INCLUDE_DIR.'/Banners.inc.php'); ?>
</td>
