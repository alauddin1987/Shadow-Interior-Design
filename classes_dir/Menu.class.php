...
*/	
	...
	{	
		...
		{
			if(CURRENT_FILE_NAME!='adminHome.php' && CURRENT_FILE_NAME!='banglaKeyboard.php')
			{
					$sql = "SELECT menu_id FROM ".TABLE_PREFIX."sys_menu WHERE menu_target='".CURRENT_FILE_NAME."'";
